<?php $__env->startSection('panel'); ?>
    ...
    <div class="row gy-4">
        <div class="col-xl-6">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?php echo app('translator')->get('Monthly Sells Report'); ?> (<?php echo app('translator')->get('This year'); ?>)</h5>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u539065483/domains/adsunlock.store/public_html/selldigital/application/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>