                    ...
                    <div>
                        <div class="row my-3 mx-1 border p-3">
                            <div class="col-md-4 d-flex flex-column justify-content-center">
                                ...
                                <div class="file-upload-wrapper" data-text="@lang('Select your file!')">
                                    <input type="file" accept=".png, .jpg, .jpeg" name="logo" class="file-upload-field" id="websiteLogoInput">
                                </div>
                            </div>
                        ...
                        <div class="row my-3 mx-1 border p-3">
                            <div class="col-md-4 d-flex flex-column justify-content-center">
                                ...
                                <div class="file-upload-wrapper" data-text="@lang('Select your file!')">
                                    <input type="file" accept=".png, .jpg, .jpeg" name="adminLogo" class="file-upload-field" id="adminLogoInput">
                                </div>
                            </div>
                            <div class="col-md-4 d-flex align-items-center justify-content-center bg--dark">
                                <img src=" {{ getImage(getFilePath('logoIcon').'/adminLogo.png', '?'
...
<script>
    $(document).ready(function () {
        ...
        $("#websiteLogoInput").change(function () {
        ...
        $("#adminLogoInput").change(function () {
            var file = this.files[0];
            if (file) {
                var reader = new FileReader();
                reader.onload = function (e) {
