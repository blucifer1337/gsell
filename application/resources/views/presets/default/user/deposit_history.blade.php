            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 mt-lg-0 mt-5">
                        <div class="tbl-wrap py-60 mt-lg-0 mt-5">
                            <form action="">
                                <div class="text-end">
                                    <div class="mb-3 d-flex justify-content-end w-50">
                                        <div class="input-group">
                                            <input type="text" name="search" class="form-control deposit-form"
                                                value="{{ request()->search }}" placeholder="@lang('Search by transactions')">
                                            <button class="input-group-text bg--base text-black deposit-btn">
                                                ...
                                                <tr>
                                                    <td data-label="Gateway">
                                                        <span class="fw-bold"> <span
                                                                class="text-white">{{ __($deposit->gateway?->name) }}</span>
                                                        </span>
