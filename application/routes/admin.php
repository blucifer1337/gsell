...
Route::middleware('admin')->group(function () {
    ...
    Route::prefix('product')->group(function () {
        ...
        Route::controller('ProductController')->name('product.')->group(function () {
            ...
            Route::post('dispatch/{product}', 'licenseKeyDispatch')->name('dispatch');

            //Manage Keys
            Route::controller('LicenseKeyController')->group(function () {
                Route::get('license/keys/{id}', 'index')->name('license.keys');
                Route::post('license/key', 'store')->name('license.store');
                Route::post('license/key/{id}', 'update')->name('license.update');
                Route::post('license/search', 'search')->name('license.search');
            });
        });
        ...
        Route::controller('OrderController')->group(function () {
            ...
            Route::get('index/preorder/{product}', 'indexPreOrder')->name('order.preorder');
            Route::get('order/{order}/{slug}', 'orderDetails')->name('order.details');
        });
        ...
        //Manage Devices
        Route::controller('DeviceController')->group(function () {
            Route::get('devices', 'index')->name('devices');
            Route::post('devices', 'store')->name('device.store');
            Route::post('devices/{id}', 'update')->name('device.update');
        });
        //Manage Platforms
        Route::controller('PlatformController')->group(function () {
            Route::get('platforms', 'index')->name('platforms');
            Route::post('platforms', 'store')->name('platform.store');
            Route::post('platforms/{id}', 'update')->name('platform.update');
        });

        //Manage Genres
        Route::controller('GenreController')->group(function () {
            Route::get('genres', 'index')->name('genres');
            Route::post('genres', 'store')->name('genre.store');
            Route::post('genres/{id}', 'update')->name('genre.update');
        });
    });
    ...
    Route::prefix('top_up')->group(function () {
        //Manage Products
        Route::controller('TopUpController')->name('topup.')->group(function () {
            Route::get('create', 'create')->name('create');
            Route::get('edit/{id}', 'edit')->name('edit');
            Route::post('update/{id}', 'update')->name('update');
            Route::post('store', 'store')->name('store');
